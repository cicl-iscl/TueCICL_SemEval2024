...
python3 script.py train_word2vec_bilstm \
    ...
    --word2vec-bilstm-checkpoint-prefix none \
    ...
    --word2vec-bilstm-load-model ~/cicl/taskC/checkpoints/word2vec-bilstm-512-2-res17pure/best.pt \
    --word2vec-bilstm-predict ~/cicl/taskC/data/predictions/word2vec.jsonl \
